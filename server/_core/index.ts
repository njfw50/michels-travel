...
async function startServer() {
  ...
  if (process.env.NODE_ENV === "development") {
    ...
    // Second try: in michels-travel/dist/public
    const distPath1 = path.resolve(import.meta.dirname, "../..", "dist", "public");
    const distPath2 = path.resolve(import.meta.dirname, "../..", "michels-travel", "dist", "public");
    
    const distPath = fs.existsSync(distPath1) ? distPath1 : 
                     fs.existsSync(distPath2) ? distPath2 : 
                     distPath1; // fallback
